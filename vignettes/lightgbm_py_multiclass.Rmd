...
traintest_split <- sklearn$train_test_split(
...
train_test_split <- function(dataset, target_col, split, seed) {
  
}
d_train <- data.table::data.table(
  cbind(traintest_split[[1]], eval(target_col) = traintest_split[[3]])
)
```
