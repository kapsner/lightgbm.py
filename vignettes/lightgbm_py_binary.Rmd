...
target_test <- lgb_learner$transform_target$transform_target(
  vector = dataset[split$test_index, get(lgb_learner$target_names)],
  mapping = "dvalid"
)
...
lgb_learner$transform_target$value_mapping_dvalid
```
