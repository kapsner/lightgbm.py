...
Make sure, the reticulate package is configured well on your system.
...
If the configuration of reticulate is bad or any other error occurs, a `miniconda` environment is installed and configured to be used with this package.
